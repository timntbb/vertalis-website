  ...
  return (
    <article className="text-neutral-300 leading-relaxed">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>An offer</li>
        <li>Acceptance</li>
        <li>A meeting of the minds</li>
        <li>Definite essential terms</li>
        <li>Consideration</li>
        <li>Intent to be bound</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Notes made during the conversation</li>
        <li>Later emails or text messages</li>
        <li>Invoices</li>
        <li>Payments</li>
        <li>Draft agreements</li>
        <li>Calendar entries</li>
        <li>Work performed</li>
        <li>The parties’ prior course of dealing</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>A promise to answer for another person’s debt</li>
        <li>A contract for the sale of real estate</li>
        <li>A lease of real estate lasting longer than one year</li>
        <li>An agreement that cannot be performed within one year</li>
        <li>Certain promises connected to marriage</li>
        <li>Certain agreements involving mineral interests</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Communicate an offer</li>
        <li>Accept proposed terms</li>
        <li>Supply a required writing</li>
        <li>Provide an electronic signature</li>
        <li>Confirm an earlier oral agreement</li>
        <li>Modify an existing contract</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Any unresolved terms</li>
        <li>Whether a formal agreement must still be signed</li>
      </ul>
      <p className="mt-4 leading-8">
