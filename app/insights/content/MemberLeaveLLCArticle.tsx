  ...
  return (
    <article className="text-neutral-300 leading-relaxed">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Stop working for the company</li>
        <li>Resign from management</li>
        <li>Give up authority over operations</li>
        <li>Sell their ownership to another member</li>
        <li>Transfer their interest to a third party</li>
        <li>Require the LLC to redeem their interest</li>
        <li>End every remaining connection with the business</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>A member deadlock</li>
        <li>A material breach by another member</li>
        <li>Loss of a required professional license</li>
        <li>A specified number of years</li>
        <li>Another defined personal or business event</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>A mandatory redemption provision</li>
        <li>A put right</li>
        <li>A buy-sell process</li>
        <li>A deadlock-triggered purchase</li>
        <li>A withdrawal provision</li>
        <li>A retirement or disability buyout</li>
        <li>A right triggered by another member’s breach</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>A fixed formula</li>
        <li>A price established by an outside offer</li>
        <li>A negotiated amount</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>A personal guarantee on a lease</li>
        <li>A guarantee of company debt</li>
        <li>A business credit card</li>
        <li>An outstanding member loan</li>
        <li>A capital contribution obligation</li>
        <li>Confidentiality or intellectual-property provisions</li>
        <li>Restrictive covenants</li>
        <li>Tax allocations for the year of departure</li>
      </ul>
      <p className="mt-4 leading-8">
