  ...
  return (
    <article className="text-neutral-300 leading-relaxed">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>A signed services agreement</li>
        <li>A proposal or statement of work</li>
        <li>A purchase order</li>
        <li>Email or text communications</li>
        <li>Change orders</li>
        <li>Delivery confirmations</li>
        <li>Time records</li>
        <li>The invoice</li>
        <li>The client’s acceptance or use of the work</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>The client overlooked the invoice.</li>
        <li>The client has a cash-flow problem.</li>
        <li>The client disputes the work or amount.</li>
        <li>The client never intended to pay voluntarily.</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Identify the unpaid invoice</li>
        <li>State the amount due</li>
        <li>Reference the applicable payment term</li>
        <li>Provide the cure deadline</li>
        <li>Explain what work will pause</li>
        <li>Reserve the company’s contractual rights</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>The parties and agreement</li>
        <li>The services or products provided</li>
        <li>The unpaid invoice</li>
        <li>The amount currently due</li>
        <li>The contractual payment deadline</li>
        <li>Any applicable interest or late fee</li>
        <li>A firm deadline for payment</li>
        <li>Where payment should be sent</li>
        <li>The next step if payment is not made</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>The amount acknowledged</li>
        <li>Payment dates</li>
        <li>Interest, if any</li>
        <li>What constitutes default</li>
        <li>Whether missed payments accelerate the balance</li>
        <li>Accepted payment methods</li>
        <li>Whether security or a personal guarantee will be provided</li>
        <li>Whether existing claims are released immediately or only after final payment</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Whether the correct defendant can be identified</li>
        <li>Whether the client has assets</li>
        <li>Whether the contract contains an arbitration clause</li>
        <li>Where the claim must be filed</li>
        <li>Whether the evidence proves performance</li>
        <li>Whether the client has viable counterclaims</li>
        <li>Whether attorney’s fees are recoverable</li>
        <li>Whether collection costs will exceed the likely recovery</li>
      </ul>
      <p className="mt-4 leading-8">
