  ...
  return (
    <article className="text-neutral-300 leading-relaxed">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>The remaining lease term</li>
        <li>Base rent and additional rent</li>
        <li>Early-termination provisions</li>
        <li>Default and cure periods</li>
        <li>Assignment and sublease rights</li>
        <li>Continuous-operation requirements</li>
        <li>Personal guarantees</li>
        <li>Casualty and condemnation provisions</li>
        <li>Landlord repair obligations</li>
        <li>Acceleration and collection remedies</li>
        <li>Surrender and restoration requirements</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Failure to obtain a permit</li>
        <li>Failure to receive zoning approval</li>
        <li>Loss of access or parking</li>
        <li>Failure to meet a sales threshold</li>
        <li>Casualty damage</li>
        <li>Condemnation</li>
        <li>Failure of a required condition</li>
        <li>Loss of an anchor tenant</li>
        <li>A negotiated early-termination option</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Several months of rent</li>
        <li>Forfeiture of the security deposit</li>
        <li>Payment of leasing commissions</li>
        <li>Payment for improvements needed to relet the space</li>
        <li>Continued rent until a replacement tenant begins paying</li>
        <li>A shortened termination date</li>
        <li>Help locating a replacement tenant</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Failure to deliver the premises</li>
        <li>Failure to complete required improvements</li>
        <li>Material interference with access</li>
        <li>Failure to perform an express repair obligation</li>
        <li>Improper exclusion from the property</li>
        <li>Material disruption of the tenant’s permitted use</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Remaining rent and additional charges</li>
        <li>Early-termination fees</li>
        <li>Assignment or sublease costs</li>
        <li>Restoration expenses</li>
        <li>Reletting commissions</li>
        <li>The security deposit</li>
        <li>Personal-guarantee exposure</li>
        <li>Litigation and collection costs</li>
        <li>The value of staying operational during negotiations</li>
      </ul>
      <p className="mt-4 leading-8">
