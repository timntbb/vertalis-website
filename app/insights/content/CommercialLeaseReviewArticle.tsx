  ...
  return (
    <article className="text-neutral-300 leading-relaxed">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Additional rent based on operating costs</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Accessibility obligations</li>
        <li>Permits and professional licenses</li>
        <li>Restrictions imposed by the property or other tenants</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>How and when the option must be exercised</li>
        <li>How renewal rent will be calculated</li>
        <li>Whether the tenant must be free of default</li>
        <li>Whether the option disappears after an assignment</li>
        <li>Whether the landlord has competing termination rights</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>The approved construction plans</li>
        <li>The tenant-improvement allowance</li>
        <li>Reimbursement requirements</li>
        <li>Contractor approval</li>
        <li>Construction delays</li>
        <li>Ownership of installed improvements</li>
        <li>Restoration obligations at move-out</li>
        <li>The condition in which the landlord must deliver the property</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Opportunities to cure</li>
        <li>Late fees and interest</li>
        <li>Acceleration of future rent</li>
        <li>Landlord liens</li>
        <li>Utility interruption</li>
        <li>Lockout rights</li>
        <li>Recovery of attorney’s fees</li>
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>A limited number of months of rent</li>
        <li>Reduction after timely performance</li>
        <li>Expiration after a specified period</li>
        <li>Release following an approved assignment</li>
        <li>A guaranty limited to obligations arising before surrender</li>
      </ul>
      <p className="mt-4 leading-8">
