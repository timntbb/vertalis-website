  ...
  return (
    <article className="text-neutral-300 leading-relaxed">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Written notice describing the default</li>
        <li>An opportunity to cure</li>
        <li>Delivery through a particular method</li>
        <li>Notice to a specific person or address</li>
        <li>Termination within a defined period</li>
        <li>Payment of undisputed amounts</li>
        <li>Return of property or confidential information</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Reimbursement of committed expenses</li>
        <li>An agreed termination fee</li>
        <li>Return of equipment or materials</li>
        <li>A transition period</li>
        <li>A release of disputed claims</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Which events qualify</li>
        <li>Whether the event must prevent or merely delay performance</li>
        <li>Notice requirements</li>
        <li>Mitigation obligations</li>
        <li>Suspension periods</li>
        <li>Termination rights after an extended interruption</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Loss of a deposit</li>
        <li>Repayment of discounts</li>
        <li>Acceleration of remaining charges</li>
        <li>Reimbursement of setup costs</li>
        <li>Attorney’s fees and collection expenses</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Confirming the contract term and renewal status</li>
        <li>Identifying available termination rights</li>
        <li>Documenting the other party’s performance failures</li>
        <li>Following the notice-and-cure procedure</li>
        <li>Calculating termination costs and potential damages</li>
        <li>Addressing property, data, payments, and transition duties</li>
        <li>Delivering notice through the required method</li>
      </ul>
      <p className="mt-4 leading-8">
