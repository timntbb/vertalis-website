  ...
  return (
    <article className="text-neutral-300 leading-relaxed">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Collection expenses</li>
        <li>Protective advances</li>
        <li>Renewal or extension amounts</li>
        <li>Modifications to the loan</li>
        <li>Future advances</li>
        <li>Other debts owed to the same lender</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>The business closes</li>
        <li>The owner resigns</li>
        <li>The owner sells the company</li>
        <li>Another person assumes operations</li>
        <li>The loan is assigned</li>
        <li>The LLC is terminated</li>
        <li>The lender takes the collateral</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Limited to a percentage of the debt</li>
        <li>Continuing or transaction-specific</li>
        <li>A guarantee of payment or collection</li>
        <li>Reduced as the loan balance declines</li>
        <li>Released after a period of successful payments</li>
        <li>Extended by renewals or modifications</li>
        <li>Secured by personal collateral</li>
        <li>Joint and several with other guarantors</li>
        <li>Subject to waivers of notice and defenses</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>A fixed dollar cap</li>
        <li>A guarantee limited to a percentage of the debt</li>
        <li>Automatic reduction as principal is repaid</li>
        <li>Release after financial benchmarks are met</li>
        <li>Expiration after a successful payment period</li>
        <li>A guarantee limited to specific defaults</li>
        <li>Notice and cure rights</li>
        <li>Exclusion of future unrelated debt</li>
        <li>Release following an approved sale</li>
        <li>Limits on default interest and collection expenses</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>The promissory note</li>
        <li>The guarantee</li>
        <li>The security agreement</li>
        <li>Payment history</li>
        <li>Modification and renewal documents</li>
        <li>Default notices</li>
        <li>Collateral records</li>
        <li>Communications with the lender</li>
        <li>Agreements among co-guarantors</li>
      </ul>
      <p className="mt-4 leading-8">
