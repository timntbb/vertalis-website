  ...
  return (
    <article className="text-neutral-300 leading-relaxed">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Economic ownership</li>
        <li>Voting rights</li>
        <li>Management authority</li>
        <li>Officer responsibilities</li>
        <li>Contract-signing authority</li>
        <li>Approval rights over major decisions</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>One member owns 80%</li>
        <li>Two members each own 10%</li>
        <li>The operating agreement does not clearly tie voting to ownership</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Hire ordinary employees</li>
        <li>Enter routine customer contracts</li>
        <li>Pay vendors</li>
        <li>Approve marketing expenses</li>
        <li>Set prices</li>
        <li>Engage service providers</li>
        <li>Manage existing projects</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Taking on substantial debt</li>
        <li>Selling major company assets</li>
        <li>Entering a merger or conversion</li>
        <li>Amending the operating agreement</li>
        <li>Changing the certificate of formation</li>
        <li>Approving a related-party transaction</li>
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Did your partner violate an internal restriction?</li>
        <li>Is the LLC still bound to the third party?</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <p className="mt-4 leading-8">
        For more, see <Link href="/insights/50-50-founder-equity-splits-hidden-risk-startup-deadlocks" className="font-medium text-neutral-200 underline decoration-[#d37a43]/45 underline-offset-4 transition-colors hover:text-[#d37a43]">50/50 LLC Deadlock in Texas</Link>.
      </p>
      <h2 className="mt-12 text-2xl font-semibold tracking-[-0.03em] text-white md:text-3xl">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Who took it</li>
        <li>What role that person held</li>
        <li>Whether the LLC is member-managed or manager-managed</li>
        <li>What the operating agreement authorizes</li>
        <li>What approval threshold applied</li>
        <li>Whether authority had been delegated</li>
        <li>Whether a third party knew about any limitation</li>
        <li>Whether the transaction can still be stopped</li>
      </ul>
      <p className="mt-4 leading-8">
        Timing matters.
      </p>
