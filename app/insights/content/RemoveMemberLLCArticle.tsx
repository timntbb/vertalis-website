  ...
  return (
    <article className="text-neutral-300 leading-relaxed">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Material breach of the Operating Agreement</li>
        <li>Fraud, theft, or misuse of company property</li>
        <li>Failure to make an agreed capital contribution</li>
        <li>Loss of a required professional license</li>
        <li>Competition with the company</li>
        <li>Bankruptcy or insolvency</li>
        <li>Criminal conduct affecting the business</li>
        <li>Failure to perform agreed responsibilities</li>
        <li>Death or permanent disability</li>
        <li>A specified vote of the other members</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Vote away an ownership interest without contractual authority</li>
        <li>Backdate amendments or transfer documents</li>
        <li>Reallocate the removed member’s percentage informally</li>
        <li>Stop required distributions as punishment</li>
        <li>Transfer company assets to a new entity to avoid the member</li>
        <li>Treat removal from employment as the loss of ownership</li>
        <li>Amend the agreement without satisfying its voting requirements</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Grounds for removal</li>
        <li>The required approval threshold</li>
        <li>Notice and hearing procedures</li>
        <li>Whether the affected member may vote</li>
        <li>A valuation method</li>
        <li>Payment timing and security</li>
        <li>Treatment of outstanding loans and guarantees</li>
        <li>Access to company information</li>
        <li>Releases and restrictive covenants</li>
        <li>A process for resolving valuation disputes</li>
      </ul>
      <p className="mt-4 leading-8">
