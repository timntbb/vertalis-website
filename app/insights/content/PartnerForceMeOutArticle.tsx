  ...
  return (
    <article className="text-neutral-300 leading-relaxed">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Who controls daily operations</li>
        <li>Whether the company is member-managed or manager-managed</li>
        <li>How managers and officers may be removed</li>
        <li>What decisions require member approval</li>
        <li>Whether a member can be expelled</li>
        <li>What events trigger a mandatory buyout</li>
        <li>How an ownership interest will be valued</li>
        <li>Whether unvested equity can be repurchased</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Terminating the member’s employment</li>
        <li>Removing the member from management</li>
        <li>Excluding the member from meetings</li>
        <li>Cutting off access to company systems</li>
        <li>Refusing to provide financial information</li>
        <li>Stopping distributions while increasing controlling-owner compensation</li>
        <li>Transferring business to a related company</li>
        <li>Issuing additional ownership to dilute the member</li>
        <li>Presenting a heavily discounted buyout offer</li>
        <li>Telling others that the member is no longer an owner</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Whether a valid triggering event occurred</li>
        <li>Whether the buyer can require the sale</li>
        <li>How the price was calculated</li>
        <li>Whether valuation discounts apply</li>
        <li>Whether payment may be made over time</li>
        <li>Whether alleged damages can be deducted</li>
        <li>How member loans will be handled</li>
        <li>Whether personal guarantees will be released</li>
        <li>Whether the documents contain releases or restrictive covenants</li>
      </ul>
      <p className="mt-4 leading-8">
