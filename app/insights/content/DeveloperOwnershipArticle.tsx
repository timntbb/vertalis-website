  ...
  return (
    <article className="text-neutral-300 leading-relaxed">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>User interfaces and visual designs</li>
        <li>Technical documentation</li>
        <li>Database architecture</li>
        <li>Product specifications</li>
        <li>APIs and integrations</li>
        <li>Inventions and improvements</li>
        <li>Testing materials</li>
        <li>Configurations and deployment scripts</li>
        <li>Other deliverables created for the project</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Cloud-hosting accounts</li>
        <li>Domain registrations</li>
        <li>App Store or Google Play accounts</li>
        <li>API credentials</li>
        <li>Deployment tools</li>
        <li>Production databases</li>
        <li>Encryption keys and administrative passwords</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Everyone who contributed to the product</li>
        <li>The agreements each contributor signed</li>
        <li>Where the code and infrastructure are located</li>
        <li>Which third-party components were used</li>
        <li>Whether the company controls the necessary accounts</li>
        <li>Whether prior assignments cover all deliverables</li>
      </ul>
      <p className="mt-4 leading-8">
