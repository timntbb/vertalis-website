  ...
  return (
    <article className="text-neutral-300 leading-relaxed">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Must the deceased member’s interest be purchased?</li>
        <li>Does the company or the surviving member make the purchase?</li>
        <li>Is the purchase mandatory or optional?</li>
        <li>How will the interest be valued?</li>
        <li>When must the valuation occur?</li>
        <li>How will the purchase price be paid?</li>
        <li>Can an heir become a full member?</li>
        <li>Who operates the company during the transition?</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>A fixed value updated annually</li>
        <li>An agreed formula based on revenue or earnings</li>
        <li>An independent business appraisal</li>
        <li>Multiple appraisals with a reconciliation process</li>
        <li>A valuation procedure established when the triggering event occurs</li>
      </ul>
      <p className="mt-4 leading-8">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Company email and cloud platforms</li>
        <li>Licenses and regulatory accounts</li>
        <li>Passwords and digital assets</li>
      </ul>
      <p className="mt-4 leading-8">
