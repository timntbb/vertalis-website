  ...
  return (
    <article className="text-neutral-300 leading-relaxed">
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        <li>Member and manager compensation</li>
        ...
        <li>Voting requirements</li>
        <li>Access to financial accounts</li>
      ...
      <ul className="mt-4 ml-6 list-disc space-y-2 leading-8">
        ...
        <li>Accounting ledgers</li>
        <li>Expense reports and receipts</li>
        <li>Payroll records</li>
        <li>Tax filings</li>
        <li>Member loan documents</li>
        <li>Emails and text messages</li>
        <li>Written consents and meeting minutes</li>
      </ul>
      <p className="mt-4 leading-8">
